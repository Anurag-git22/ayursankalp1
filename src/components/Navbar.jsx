...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { label: 'Ayurveda Tips & Blog', path: '/blog' },
      ...
      <nav className={`transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <button
            ...
            className="lg:hidden p-2 rounded-lg text-[#1F2E22] hover:bg-[#EAF2E8] transition-colors focus-visible:ring-2 focus-visible:ring-[#2F5233] focus-visible:outline-hidden"
