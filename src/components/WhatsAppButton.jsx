...
export default function WhatsAppButton() {
  ...
  const whatsappLink = `https://wa.me/919028536848?text=${defaultMessage}`;
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end pointer-events-auto">
      ...
      {isTooltipOpen && (
        <div className="mb-2.5 max-w-[220px] bg-white rounded-2xl p-3 shadow-xl border border-[#2F5233]/15 text-xs text-[#1F2E22] relative animate-in fade-in slide-in-from-bottom-2 duration-300">
          ...
          <div className="font-semibold text-[#2F5233] pr-3">
            {language === 'mr' ? 'थेट व्हॉट्सॲपवर विचारा' : 'Direct Clinic WhatsApp'}
          </div>
          <p className="text-[11px] text-[#1F2E22]/75 mt-0.5 leading-snug">
            {language === 'mr' 
              ? 'अपॉइंटमेंट किंवा उपचारांविषयी काही शंका असल्यास संपर्क करा.'
              : 'Have questions or want to book via WhatsApp? Reach out to Dr. Kadam.'}
          </p>
        </div>
      )}
      ...
      <a
        ...
        aria-label="Chat with Dr. Ruturaj Kadam on WhatsApp at +91 90285 36848"
      >
        {/* WhatsApp Icon */}
        <svg
        ...
        <span className="text-xs font-semibold tracking-wide hidden sm:inline">
          {language === 'mr' ? 'व्हॉट्सॲप' : 'WhatsApp'}
        </span>
      </a>
